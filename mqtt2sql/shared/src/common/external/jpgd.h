...
namespace jpgd
{
	...
	unsigned char* decompress_jpeg_image_from_memory(const unsigned char* pSrc_data, int32_t src_data_size, int32_t* width, int32_t* height, int* actual_comps, int32_t req_comps, uint32_t flags = 0);
